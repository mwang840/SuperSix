...
function addPieceToGrid(className, color, piece, id){
    document.getElementsByClassName("grid")[0].innerHTML += `<div class="is-piece ` + className + `" id="` + id + `"><img width="70px" height="70px" src="images/pixel-pieces/` + color + `-` + piece + `.png" ondragover="allowDrop(event)" ondrop="drop(event)">`; //there's only one grid
